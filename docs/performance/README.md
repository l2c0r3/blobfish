...
[MateAwareEvaluation.java](../../src/main/java/ch/hslu/cas/msed/blobfish/eval/MateAwareEvaluation.java)).
...
- The [Mate aware material evaluation](../../src/main/java/ch/hslu/cas/msed/blobfish/eval/MateAwareEvaluation.java) has a negative impact on the calculation time
...
of [Mate aware material evaluation](../../src/main/java/ch/hslu/cas/msed/blobfish/eval/MateAwareEvaluation.java) we can build
the following table
