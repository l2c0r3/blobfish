...
Die nachfolgenden Tests wurden mit dem Stand vom Commit [4ce0b1](https://github.com/l2c0r3/blobfish/commit/4ce0b1877b0fe86aaf6db7ece79d2c5d7342798e)
durchgeführt. Die Rohdaten von den Ergebnissen findet ihr hier: [performance-diagrams/4ce0b1](../../plantuml/performance-diagrams/4ce0b1)

**Complex Position With Many Options (FEN 1r4r1/5p1k/p2p1q1p/2b1nPQ1/p7/6RP/B1R2PPK/2B5 b - - 0 1)**

![ComplexPositionWithManyOptions.png](ComplexPositionWithManyOptions.png)

**MidGame Promotion Mate in 2 (FEN 5r1k/1pqnbr1P/p2p1pQp/2p5/3PP2P/1PN5/1PP3R1/R5K1 w - - 0 24)**

![MidGame-Promotion-MateIn2-Short.png](MidGame-Promotion-MateIn2-Short.png)

**MidGame Fork (FEN r3k2r/pNp1ppbp/2nq2pn/7P/2B3b1/3P1N2/PPP2PP1/R1BQK2R b KQkq - 0 11)**

![MidGame-Fork-Short.png](MidGame-Fork-Short.png)

**MidGame EnPassant (FEN rn1q1r1k/pbpp1p1p/1p2p3/4P3/3P2Qp/P2B4/1PP2PPP/R4RK1 w - - 0 17)**

![MidGame-EnPassant-Long.png](MidGame-EnPassant-Long.png)

**MidGame Discovery (FEN r5k1/7p/1p1Qp1p1/p1np1r2/1q3P1P/1P6/2P3P1/RB3RK1 w - - 3 26)**

![MidGame-Discovery-Short.png](MidGame-Discovery-Short.png)

**MidGame Discovery Mate in 2 (FEN Q7/p1pk3p/2p2qp1/3p1b2/8/1PN1P3/P1PP2PP/R4KNR b - - 4 15)**

![MidGame-Discovery-MateIn2-Short.png](MidGame-Discovery-MateIn2-Short.png)

**MidGame Deflection (FEN 5rk1/5q1p/p2PR1p1/4p1b1/1pP5/1P1Q4/P5PP/1K2R3 b - - 0 31)**

![MidGame-Deflection-Short.png](MidGame-Deflection-Short.png)

**EndGame Deflection (FEN 8/5ppk/4p1p1/3pq3/3Q4/1B2r2P/P5P1/3R3K b - - 8 42)**

![EndGame-Deflection-Short.png](EndGame-Deflection-Short.png)
