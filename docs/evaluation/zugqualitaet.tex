...
Ebenfalls positiv zu sehen ist, dass mittels 3 Evaluationen bereits 72\% der Punkte erreicht werden konnten.

Das als zweitplatzierter der \textit{MaterialEval} gewinnt, sagt uns, dass in den Testpositionen mehr das schlagen
der gegnerischen Figuren mehr Gewicht hatte es auf den ersten Blick scheint, das es im generellen der Materialwert ein
guter erster Indikator ist, die Position zu bewerten. \\
Die finesse, welche die \textit{PieceSquareEval} jedoch nun hinzufügt, verbessert die Evaluation im ca. 38\%. So ist
...
Schaut man sich nun die Kategori
