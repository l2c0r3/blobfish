...
Alle Diagramme befinden sich im Anhang unter Rechenzeit Daten~\ref{ch:performance_data} und ehen wie folgt aus.
...
Der Grund dafür ist der grosse Unterschied der Rechenzeiten - der Test wurde viel zu lange dauern.
...
\begin{table}[H]
    \centering
    \resizebox{\textwidth}{!}{%
        \input{report/performance/performance-gains-minimaxsequential-at-depth-5-by-strategy}
    }
...
Jedoch wäre die nötige Anzahl CPUs bei grösseren Zugtiefen fast nicht erreichbar um die gleiche Leistung zu Alpha-Beta-Pruning zu erreichen, da bei jeder zusätzlichen Tiefe die Anzahl nötigen Evaluationen exponentiell steigen kann.
