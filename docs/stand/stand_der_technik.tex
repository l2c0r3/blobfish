...
Wichtig ist jedoch, dass die jeweils daraus erstellte \gls{glos:elo}'s sich nicht direkt miteinander vergleichen lassen.
...
So existieren bei der FIDE \gls{glos:fide} auch unterschiedliche \gls{glos:elo}'s für die unterschiedlichen Schachvarianten wie
