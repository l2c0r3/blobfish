...
Eine Möglichkeit, diese Logik in einer Schach-Engine zu implementieren, ist die Verwendung von Piece Square Tabellen (deu.\ Figurenfeldtabellen), abgekürzt \gls{glos:psqt}.
...
Beispielsweise weist ein König in der Eröffnung und im Mittelspiel drastisch andere PSQT-Werte auf als im Endspiel.
...
\begin{figure}[H]
    ...
    \end{minipage}
    \caption{Beispiel PSQT für den König, je nach Partiephase}
    \label{fig:king-psqt-example}
\end{figure}

Die Werte in der Abbildung~\ref{fig:king-psqt-example} sind Prozentsätze eines Punktes.
