...
\begin{itemize}
    ...
    \item Dame - 900
\end{itemize}
Da der König nicht gefressen werden kann, aber trotzdem ein Angriffsziel bleiben soll, wurde für diese Figur ein grosser Basiswert definiert - 99, multipliziert durch 100, ergibt 9900.
\lstinputlisting[
    firstline=8,
    lastline=14,
    firstnumber=8,
...
Die Implementation der \gls{glos:pst} Evaluation ist ziemlich einfach und befindet sich im folgenden Code-Abschnitt.
\lstinputlisting[
    firstline=9,
    lastline=38,
    firstnumber=9,
