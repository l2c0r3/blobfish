...
\begin{itemize}
    ...
    \item Dame - 900
\end{itemize}
Da der König nicht gefressen werden kann, aber trotzdem ein Angriffsziel bleiben soll, wurde für diese Figur ein grosser Basiswert definiert - 99, multipliziert mit 100, ergibt 9900.
\lstinputlisting[
    firstline=8,
    lastline=14,
    firstnumber=8,
...
Folglich wird durch das ganze Brett iteriert und überall wo sich eine Figur befindet, wird deren Wert aus der entsprechenden \gls{glos:pst} ausgelesen.
