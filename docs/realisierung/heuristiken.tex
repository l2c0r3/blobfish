...
Für die materialistische Evaluation wurde die Standardvariation der Basiswerte verwendet, jedoch mit 100 multipliziert, um weitere Verfeinerungen leichter berechnen zu können.
Somit haben die Schafiguren folgenden Basiswerte:
\begin{itemize}
    \item Bauer - 100
    \item Springer - 300
    \item Läufer - 300
    ...
    \item Dame - 900
\end{itemize}
Da der König nicht genommen werden kann, aber trotzdem ein Angriffsziel bleiben soll, wurde für diese Figur ein grosser Basiswert definiert - 99, multipliziert durch 100, ergibt 9900.
\lstinputlisting[
    firstline=8,
    lastline=14,
    firstnumber=8,
    caption={Code - Basiswerte der Schachfiguren},
...
Bei einer positiven Endsumme hat der Spieler mit den weissen Figuren den Vorteil, bei einer negativen Summe hat der Spieler mit den schwarzen Figuren den Vorteil, und bei einem Ergebnis von 0 ist die Position in Bezug auf das Material ausgeglichen.
\lstinputlisting[
    firstline=18,
    lastline=40,
    firstnumber=18,
    caption={Code - Materialistische Evaluation},
    label={lst:material-evaluation}
]{../src/main/java/ch/hslu/cas/msed/blobfish/eval/MaterialEval.java}
...
Es wurde die gleiche Logik wie bei \gls{glos:lichess} verwendet, nämlich befindet sich die Partie im Endspiel, sobald nicht mehr als 6 Schachfiguren im Spiel sind.
